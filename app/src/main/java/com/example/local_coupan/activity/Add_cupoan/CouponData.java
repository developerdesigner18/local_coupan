...
package com.example.local_coupan.activity.Add_cupoan;
...
public class CouponData {
    ...
    public Integer getUserUseCode() {
        return userUseCode;
    }

    public void setUserUseCode(Integer userUseCode) {
